...
## Menu
- [Evolution of Large Pre-trained Model](#evolution-of-large-pre-trained-model)
...
- [Applications of Large Pre-trained Models in Image- Text Tasks](#applications-of-large-pre-trained-models-in-image-text-tasks)
...
## Evolution of Large Pre-trained Model
### Early Pre-trained Model
|Paper|Published in|
|---|:---:|
|[Distributed representations of sentences and documents](http://arxiv.org/abs/1405.4053v2)|arXiv 2014|
|[Enriching word vectors with subword information](http://dx.doi.org/10.1162/tacl_a_00051)|TACL 2018|
|[Deep contextualized word representations](http://dx.doi.org/10.18653/v1/n18-1202)|-|
...
|[Learned in translation: Contextualized word vectors](http://arxiv.org/abs/1708.00107v2)|arXiv 2017|
|[On the performance of googlenet and alexnet applied to sketches](http://dx.doi.org/10.1609/aaai.v30i1.10171)|AAAI 2022|
|[Study of adam and adamax optimizers on alexnet architecture for voice biometric authentication system](http://dx.doi.org/10.1109/imcom56909.2023.10035592)|-|
...
|[Dropout alexnet-extreme learning optimized with fast gradient descent optimization algorithm for brain tumor classification](https://onlinelibrary.wiley.com/doi/abs/10.1002/cpe.7543)|-|
|[Placing images with refined language models and similarity search with pca-reduced VGG features](https://www.semanticscholar.org/paper/Placing-Images-with-Refined-Language-Models-and-VGG-Kordopatis-Zilos-Popescu/7f05df12dff3defee495507abd4870a0a30c3590)|-|
|[A novel approach for early recognition of cataract using VGG-16 and custom user-based region of interest](http://dx.doi.org/10.1145/3512353.3512356)|-|
...
|[Going deeper with convolutions](http://dx.doi.org/10.1109/cvpr.2015.7298594)|-|
|[Deep residual learning for image recognition](http://dx.doi.org/10.1109/cvpr.2016.90)|-|
|[Attention is all you need](http://arxiv.org/abs/1906.02792v1)|arXiv 2019|
...
|[Swin transformer: Hierarchical vision transformer using shifted windows](http://dx.doi.org/10.1109/iccv48922.2021.00986)|-|
|[End-to-End Object Detection with Transformers](http://dx.doi.org/10.1007/978-3-030-58452-8_13)|-|
...
|[Revisiting pre-trained models for chinese natural language processing](http://dx.doi.org/10.18653/v1/2020.findings-emnlp.58)|-|
...
|[Glm: General language model pretraining with autoregressive blank infilling](http://dx.doi.org/10.18653/v1/2022.acl-long.26)|-|
...
|[Lxmert: Learning cross-modality encoder representations from transformers](http://dx.doi.org/10.18653/v1/d19-1514)|-|
...
|[Vinvl: Revisiting visual representations in vision-language models](http://dx.doi.org/10.1109/cvpr46437.2021.00553)|-|
...
|[An empirical study of training end-to-end vision-and-language transformers](http://dx.doi.org/10.1109/cvpr52688.2022.01763)|-|
...
|[EVA: exploring the limits of masked visual representation learning at scale](http://dx.doi.org/10.1109/cvpr52729.2023.01855)|-|

## Applications of Large Pre-trained Models in Image- Text Tasks
### Image Caption Generation
|Paper|Published in|
|---|:---:|
|[mplug: Effective and efficient vision-language learning by cross-modal skip-connections](http://dx.doi.org/10.18653/v1/2022.emnlp-main.488)|-|
|[BLIP-2: bootstrapping language-image pre-training with frozen image encoders and large language models](https://arxiv.org/abs/2301.12597)|arXiv 2023|
...
|[Visualgpt: Data-efficient adaptation of pretrained language models for image captioning](http://dx.doi.org/10.1109/cvpr52688.2022.01750)|-|
|[Haav: Hierarchical aggregation of augmented views for image captioning](http://dx.doi.org/10.1109/cvpr52729.2023.01062)|-|
|[BSAM: research on image-text matching method based on bert and self-attention mechanism](http://dx.doi.org/10.1109/smc53654.2022.9945109)|-|
### Image-Text Matching
|Paper|Published in|
|---|:---:|
...
|[Neural network decision-making criteria consistency analysis via inputs sensitivity](http://dx.doi.org/10.1109/icpr56361.2022.9956394)|-|
|[Visual relationship detection: A survey](http://dx.doi.org/10.1109/tcyb.2022.3142013)|IEEE Trans. Cybern. 2022|
|[Stacked cross attention for image-text matching](http://dx.doi.org/10.1007/978-3-030-01225-0_13)|-|
...
|[Image-text matching with fine-grained relational dependency and bidirectional attention-based generative networks](http://dx.doi.org/10.1145/3503161.3548058)|-|
...
|[Ask me anything: Free-form visual question answering based on knowledge from external sources](http://dx.doi.org/10.1109/cvpr.2016.500)|-|
...
|[Towards context-aware interaction recognition for visual relationship detection](http://dx.doi.org/10.1109/iccv.2017.71)|-|
|[Scene graph generation by iterative message passing](http://dx.doi.org/10.1109/cvpr.2017.330)|-|
|[Modeling relationships in referential expressions with compositional modular networks](http://dx.doi.org/10.1109/cvpr.2017.470)|-|
### Visuall Grounding
|Paper|Published in|
|---|:---:|
|[A fast and accurate one-stage approach to visual grounding](http://dx.doi.org/10.1109/iccv.2019.00478)|-|
...
|[Transvg: End-to-end visual grounding with transformers](http://dx.doi.org/10.1109/iccv48922.2021.00179)|-|
|[High-resolution image synthesis with latent diffusion models](http://dx.doi.org/10.1109/cvpr52688.2022.01042)|-|
